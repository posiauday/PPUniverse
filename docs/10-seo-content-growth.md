...
## Page templates
Product, category, collection, comparison, tutorial, pattern, glossary, troubleshooting, generator/tool, creator and learning path. Each page must satisfy a distinct intent and avoid thin programmatic duplication.
...
## Product-led loops
Free asset to account; account to saved library; library to update notification; tutorial to component; component to bundle; creator product to creator audience; verified deployment story to case study.
...
## Measurement
Search impressions, qualified clicks, page-to-product navigation, search zero-results, free activation, email consent, purchase conversion, repeat usage, content-assisted revenue and creator-attributed acquisition.
